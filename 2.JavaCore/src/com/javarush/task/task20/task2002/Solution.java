...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            File yourFile = new File("C:/testWrite.txt");
            ...
            test.setMale(true);
            test.setCountry(User.Country.RUSSIA);
    ...
    public static class JavaRush {
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            String firstName, lastName, birthDate, isMale, country;
            while ((firstName = bufferedReader.readLine()) != null &&
                    (lastName = bufferedReader.readLine()) != null &&
                    (birthDate = bufferedReader.readLine()) != null &&
                    (isMale = bufferedReader.readLine()) != null &&
                    (country = bufferedReader.readLine()) != null)
            {
                User user = new User();
