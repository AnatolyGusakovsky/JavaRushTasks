    ...
    public Sayable toSayable(final int i) {
        class DogPet extends SuperDog implements Sayable{
            private String getName(){
                return super.getSuperQuotes().concat(name).concat(super.getSuperQuotes());
            }
            ...
            public String say() {
               if (i < 1) {
                   ...
                   String sCertDate = formatter.format(new Date());
                   return String.format(getName() + " лает г%sв! %s", a, sCertDate);
